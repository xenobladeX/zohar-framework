 ...
 */
package com.xenoblade.zohar.framework.commons.api.validate;

import java.util.ArrayList;
import java.util.List;

/**
 * SimpleValidateResults
 * @author xenoblade
 * @since 1.0.0
 */
public class SimpleValidateResults implements ValidateResults {

    private static final long serialVersionUID = -1968382309766143457L;
    ...
    @Override public List<ValidateResults.Result> getResults() {
        return results;
    }
