...
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.filter.stateless.JwtAuthcFilter;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.filter.stateless.JwtPermsFilter;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.filter.stateless.JwtRolesFilter;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.model.AuthorizeRule;
...
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.exception.IllegalConfigException;
...
public class FilterManager {
    ...
    public void initFilters(){
        ...
        XenoFormAuthenticationFilter formFilter = new XenoFormAuthenticationFilter();
        ...
        XenoRolesAuthorizationFilter rolesFilter = new XenoRolesAuthorizationFilter();
        this.statefulFilters.putIfAbsent(Commons.FILTER_ROLES, rolesFilter);

        XenoPermissionsAuthorizationFilter permsFilter = new XenoPermissionsAuthorizationFilter();
        this.statefulFilters.putIfAbsent(Commons.FILTER_PERMS, permsFilter);

        XenoUserFilter userFilter = new XenoUserFilter();
    ...
    public Map<String, String> getAllFilterChain() {
        ...
        log.info("filterChains:"+allFilterChain);
