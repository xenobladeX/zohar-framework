...
public class SecurityManagerConfig {
    ...
    /**
     * 设置账号信息提供者
     * @param accountProviderImpl  see {@link ShiroAccountProvider}
     */
    ...
    /**
     * 设置密码错误次数超限处理器
     * @param passwdRetryLimitHandlerImpl  see {@link PasswdRetryLimitHandler}
     */
     ...
     *
     * @param statelessAccountProviderImpl  see {@link ShiroStatelessAccountProvider}
     */
     ...
     *
     * @param rememberMeCookie  see {@link SimpleCookie}
     */
     ...
     *
     * @param sessionDAO  see {@link SessionDAO}
     */
     ...
     *
     * @param cacheManager  see {@link CacheManager}
     */
