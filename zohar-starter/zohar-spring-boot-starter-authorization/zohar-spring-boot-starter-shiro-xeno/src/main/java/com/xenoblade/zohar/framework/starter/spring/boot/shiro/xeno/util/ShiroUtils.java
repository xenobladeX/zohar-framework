 ...
 */
package com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.util;

import java.util.Collections;
import java.util.List;
import javax.servlet.http.HttpServletRequest;

import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.StatelessLocals;
...
public class ShiroUtils {
    ...
    public static String issueJwt(String subject,String issuer,Long period,String roles,String permissions,SignatureAlgorithm algorithm) {
        return CryptoUtils.issueJwt(shiroProperties.getJwtSecretKey(),subject,issuer,period,roles,permissions,algorithm);
    }
    /**
     * 验签JWT
     *
