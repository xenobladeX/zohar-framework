...
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.XenoModularRealmAuthenticator;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.XenoPasswdMatcher;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.XenoSubjectFactory;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.cache.CacheDelegator;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.cache.MapCacheManager;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.cache.RedisCacheManager;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.cache.SpringCacheManager;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.filter.FilterManager;
...
public class XenoShiroManager {
    ...
    private XenoPasswdMatcher passwdMatcher;
    ...
    protected XenoShiroManager(BeanFactory beanFactory,ShiroProperties properties,
    ...
    private void buildCacheManager() {
        ...
        log.info("shiro-xeno cacheManager: "+this.cacheManager);
    }
    ...
    private void buildPasswdMatcher() {
        ...
        XenoPasswdMatcher passwdMatcher = new XenoPasswdMatcher();
    ...
    private void buildRealmManager() {
        ...
        realmManager.setXenoPasswdMatcher(this.passwdMatcher);
    ...
    private void buildSecurityManager(){
        ...
        securityManager.setAuthenticator(new XenoModularRealmAuthenticator());
        ...
        XenoSubjectFactory subjectFactory = new XenoSubjectFactory(storageEvaluator);
    ...
    public XenoPasswdMatcher getPasswdMatcher() {
