 ...
 */
package com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.realm;

import java.util.Collections;
import java.util.List;

import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.XenoHmacMatcher;
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.authc.XenoJwtMatcher;
...
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.xeno.service.DefaultStatelessAccountProvider;
...
public class RealmManager {
    ...
    public void initRealms(){
        ...
        if (this.properties.isHmacEnabled()) {
            XenoHmacMatcher hmacMatcher = new XenoHmacMatcher();
        ...
        if (properties.isJwtEnabled()) {
            XenoJwtMatcher jwtMatcher = new XenoJwtMatcher();
        ...
        this.customRealms.forEach(realm -> {
            if (realm instanceof AuthorizingRealm) {
                ...
                if(null == authorizingRealm.getCredentialsMatcher()){
                    authorizingRealm.setCredentialsMatcher(xenoPasswdMatcher);
                }
    ...
    public void setXenoPasswdMatcher(XenoPasswdMatcher xenoPasswdMatcher) {
        this.xenoPasswdMatcher = xenoPasswdMatcher;
    }
