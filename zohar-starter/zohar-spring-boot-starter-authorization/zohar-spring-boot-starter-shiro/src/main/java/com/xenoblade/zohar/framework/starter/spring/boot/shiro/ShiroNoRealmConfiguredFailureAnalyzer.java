...
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.exception.NoRealmBeanConfiguredException;
 ...
 * @since 1.0.0
 */
public class ShiroNoRealmConfiguredFailureAnalyzer extends
        AbstractFailureAnalyzer<NoRealmBeanConfiguredException> {
