 ...
 */
package com.xenoblade.zohar.framework.starter.spring.boot.shiro


import com.xenoblade.zohar.framework.starter.spring.boot.shiro.ShiroAutoConfigurationTestApplication.EventBusAwareObject
import com.xenoblade.zohar.framework.starter.spring.boot.shiro.ShiroAutoConfigurationTestApplication.SubscribedListener
...
public class ShiroSpringAutoConfigurationTest {
    ...
    @Autowired
    private ShiroAutoConfigurationTestApplication.EventBusAwareObject eventBusAwareObject

    @Autowired
    private ShiroAutoConfigurationTestApplication.SubscribedListener subscribedListener
