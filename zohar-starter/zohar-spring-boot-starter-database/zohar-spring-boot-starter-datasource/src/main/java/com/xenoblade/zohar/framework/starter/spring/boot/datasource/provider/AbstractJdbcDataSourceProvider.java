 ...
 */
package com.xenoblade.zohar.framework.starter.spring.boot.datasource.provider;

import com.xenoblade.zohar.framework.starter.spring.boot.datasource.DynamicDataSourceCreator;
import com.xenoblade.zohar.framework.starter.spring.boot.datasource.autoconfigure.DataSourceProperty;
import com.xenoblade.zohar.framework.starter.spring.boot.datasource.autoconfigure.DynamicDataSourceProperties;
...
public abstract class AbstractJdbcDataSourceProvider implements DynamicDataSourceProvider {
     ...
     */
    protected abstract Map<String, DataSourceProperty> executeStmt(Statement statement) throws
            SQLException;
}
