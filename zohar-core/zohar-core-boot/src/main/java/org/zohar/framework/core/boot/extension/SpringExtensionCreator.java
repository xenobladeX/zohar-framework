...
import org.zohar.framework.core.plugin.creator.ExtensionCreator;
...
public class SpringExtensionCreator implements ExtensionCreator {
    ...
    public <T> T create(Class<T> extensionClass) {
        ...
        log.debug("Instantiate plugin class '" + ClassUtil.getClassName(extensionClass, false) + "' by using constructor autowiring.");
        ...
        final Object autowiredExtension = beanFactory.autowire(extensionClass, AUTOWIRE_CONSTRUCTOR,
                ...
                false);
        log.trace("Created plugin instance by constructor injection: " + autowiredExtension);

        log.debug("Completing autowiring of plugin: " + autowiredExtension);
        // Autowire by using remaining kinds of injection (e. g. setters and/or fields).
        beanFactory.autowireBean(autowiredExtension);
        log.trace("Autowiring has been completed for plugin: " + autowiredExtension);
