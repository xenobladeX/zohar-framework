...
public class SpringPluginClassLoader extends PluginClassLoader {
    ...
    public Class<?> loadClass(String className) throws ClassNotFoundException {
        ...
        return _loadClassFromDependencies(className);
    }
    ...
    private Class<?> _loadClassFromDependencies(String className) throws ClassNotFoundException {
        try {
