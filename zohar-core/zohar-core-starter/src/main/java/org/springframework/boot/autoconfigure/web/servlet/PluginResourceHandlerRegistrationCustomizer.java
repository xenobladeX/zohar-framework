...
public class PluginResourceHandlerRegistrationCustomizer implements
        ...
        ApplicationListener<ZoharPluginStateChangedEvent> {

    private static final String DEFAULT_CACHE_NAME = "pf4j-resource-chain-cache";
    ...
    @Qualifier("pf4jResourceCache")
    private Cache pf4jResourceCache;

    @Override
    public void customize(ResourceHandlerRegistration registration) {
        if (pf4jResourceCache == null) {
            pf4jResourceCache = new ConcurrentMapCache(DEFAULT_CACHE_NAME);
        }
        ResourceProperties.Chain properties = this.resourceProperties.getChain();
        ResourceChainRegistration chain = registration.resourceChain(properties.isCache(),
                pf4jResourceCache);
    ...
    @Override
    public void onApplicationEvent(ZoharPluginStateChangedEvent event) {
        if (pf4jResourceCache == null) return;
        pf4jResourceCache.clear();
    }
}
