 ...
 */
package org.zohar.framework.core.api.exception;
...
public abstract class BaseException extends RuntimeException {
    ...
    /**
     * Whether fill in stack traces when throw exception
     */
    private Boolean enableFillInStackTrace = true;
    ...
    public BaseException setEnableFillInStackTrace(Boolean enableFillInStackTrace) {
        this.enableFillInStackTrace = enableFillInStackTrace;
        return this;
    }

    @Override
    public synchronized Throwable fillInStackTrace() {
        if (enableFillInStackTrace) {
