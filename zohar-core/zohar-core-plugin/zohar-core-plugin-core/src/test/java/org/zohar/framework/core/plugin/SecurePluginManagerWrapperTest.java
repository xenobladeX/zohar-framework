...
import org.zohar.framework.core.plugin.SecurePluginManagerWrapper;
...
public class SecurePluginManagerWrapperTest {
    ...
    public void setUp() throws IOException {
        ...
        thisPlugin = new PluginJar.Builder(pluginsPath.resolve("test-plugin1.jar"), THIS_PLUGIN_ID).pluginClass(
                TestPlugin.class.getName()).pluginVersion("1.2.3").extension(TestExtension.class.getName()).build();
