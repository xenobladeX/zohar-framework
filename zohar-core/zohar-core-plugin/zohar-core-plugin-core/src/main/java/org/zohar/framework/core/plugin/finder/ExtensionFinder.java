...
public interface ExtensionFinder {
    ...
    /**
     * Retrieves a list with all extensions found for an plugin point.
     */
    <T> List<ExtensionWrapper<T>> find(Class<T> type);

    /**
     * Retrieves a list with all extensions found for an plugin point and a plugin.
     */
    ...
    /**
     * Retrieves a list with all plugin class names found for a plugin.
     */
