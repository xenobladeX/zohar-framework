 ...
 */
package org.zohar.framework.core.web;
...
public class WebFormatTest {
    ...
    public void testResponseException() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get("/test/baseException"))
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().json("{\"errCode\":100001,\"errMessage\":\"Inner Error\"}"));
    }
