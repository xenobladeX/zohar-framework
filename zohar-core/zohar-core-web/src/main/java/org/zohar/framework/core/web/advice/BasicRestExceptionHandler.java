 ...
 */
package org.zohar.framework.core.web.advice;
...
import org.zohar.framework.core.api.dto.Response;
import org.zohar.framework.core.api.validate.SimpleValidateResults;
...
public class BasicRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Response> handleException(HttpServletRequest request, final Throwable ex,
    ...
    public ResponseEntity<Response> handleNotFoundException(HttpServletRequest request,
    ...
    public ResponseEntity<Response> handleJsonProcessingException(HttpServletRequest request,
            final JsonProcessingException ex, HttpServletResponse response) {
    ...
    public ResponseEntity<Response> handleConstraintViolationException(HttpServletRequest request,
            final ConstraintViolationException ex, HttpServletResponse response) {
        ...
        ex.getConstraintViolations()
                ...
                .forEach(violation -> results.addResult(violation.getPropertyPath().toString(),
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        if (ex.getContentType() != null) {
            responseBody.setErrMessage(
                    StrUtil.format("Media type {} not supported", ex.getContentType()));
        }
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        if (StrUtil.isNotEmpty(ex.getParameterName())) {
            String message = StrUtil.format("Servlet request param '{}' is missed",
                    ex.getParameterName());
            responseBody.setErrMessage(message);
        }
        return ResponseEntity.status(HttpStatus.OK)
    ...
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex,
        ...
        String messsage = StrUtil.format("Can't convert type '{}' to type '{}'",
                ClassUtils.getDescriptiveType(ex.getValue()), ex.getValue(), ex.getRequiredType());
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ex.getBindingResult().getAllErrors()
                ...
                .forEach(fieldError -> results.addResult(fieldError.getField(),
    ...
    protected ResponseEntity<Object> handleMissingServletRequestPart(
        ...
        Response responseBody = Response
                .error(BasicErrorCode.PARAM_MISS,
                        StrUtil.format("miss request part {}", ex.getRequestPartName()));
        return ResponseEntity.status(HttpStatus.OK)
                .body(responseBody);
    }
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        String message = StrUtil.format("Can't find handler for uri {} with method {}",
