 ...
 */
package com.xenoblade.zohar.framework.sample.baal.controller.v1;
...
import com.xenoblade.zohar.framework.commons.web.version.ApiVersion;
...
@Validated
@Slf4j
public class BaalV1Controller implements BaalService{
    ...
    public ResponseMessage<HelloBaalResponse> helloBaal(@RequestBody HelloBaalRequest request) {
        ...
        response.setResponse("Hello, this is baal v1");
