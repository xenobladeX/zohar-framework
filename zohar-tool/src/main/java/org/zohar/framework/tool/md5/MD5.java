 ...
 */
package org.zohar.framework.tool.md5;
 ...
 * @Desc MD5
 * @author dingming
 * @date 2019年07月31日 2:03 PM
 * @version
 */
public class MD5 implements Serializable {

    private static final long serialVersionUID = 9150420240235123864L;
    ...
    public String asBase64() {
        return Base64.encode(this.Final());
    }
 ...
 * Date Author Note
 * -------------------------------------------------------------------------
 * 2019年07月31日 2:03 PM dingming create
 */
