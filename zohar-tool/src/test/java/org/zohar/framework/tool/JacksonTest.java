 ...
 */
package org.zohar.framework.tool;

import org.zohar.framework.tool.bean.TestBigNumberBean;
import org.zohar.framework.tool.bean.TestDateBean;
import org.zohar.framework.tool.bean.TestNullBean;
import org.zohar.framework.tool.extension.TestJacksonUtilConfigurer;
import org.zohar.framework.tool.jackson.JacksonUtil;
...
public class JacksonTest {
    ...
    public void testSerialDateBean() {
        ...
        Assert.assertEquals(
                "{\"localDateTime\":\"2022-02-03 16:57:00\",\"date\":\"2022-02-03 16:57:00\"}",
                dateBeanJason);
    }
    ...
    public void testSerialBigNumBean() {
        ...
        Assert.assertEquals(
                "{\"aBigDecimal\":\"3.12435\",\"aLong\":\"343254356884645753\",\"anotherLong\":\"4796904892307445488\"}",
                bigNumBeanJson);
    }
